...
#Concatenating input files to run MBAR over all different P and T
os.system("paste 50.0/processed_data/hconf.dat 60.0/processed_data/hconf.dat 70.0/processed_data/hconf.dat 80.0/processed_data/hconf.dat 90.0/processed_data/hconf.dat > All/processed_data/hconf.dat")
os.system("paste 50.0/processed_data/uconf.dat 60.0/processed_data/uconf.dat 70.0/processed_data/uconf.dat 80.0/processed_data/uconf.dat 90.0/processed_data/uconf.dat > All/processed_data/uconf.dat")
os.system("paste 50.0/processed_data/volume.dat 60.0/processed_data/volume.dat 70.0/processed_data/volume.dat 80.0/processed_data/volume.dat 90.0/processed_data/volume.dat > All/processed_data/volume.dat")
os.system("paste 50.0/processed_data/temperature.dat 60.0/processed_data/temperature.dat 70.0/processed_data/temperature.dat 80.0/processed_data/temperature.dat 90.0/processed_data/temperature.dat > All/processed_data/temperature.dat")
os.system("paste 50.0/processed_data/pressure.dat 60.0/processed_data/pressure.dat 70.0/processed_data/pressure.dat 80.0/processed_data/pressure.dat 90.0/processed_data/pressure.dat > All/processed_data/pressure.dat")
...
for directory in processed_data:
    ...
    NIST2 = '%(NIST_directory)sNIST2.dat' % vars()
    NIST3 = '%(NIST_directory)sNIST3.dat' % vars()
    NIST4 = '%(NIST_directory)sNIST4.dat' % vars()
    NIST5 = '%(NIST_directory)sNIST5.dat' % vars()
    NIST6 = '%(NIST_directory)sNIST6.dat' % vars()
    ...
    gnuplot_input = """
        ...
        set xrange [250:700]
        set yrange [100:350]
        set label "90 MPa" at 640,195
        set label "80 MPa" at 640,180
        set label "70 MPa" at 640,164
        set label "60 MPa" at 640,147
        set label "50 MPa" at 640,128
        plot "%(data_STD)s" u 1:15 t "STD estimate" with points pt 7 lc rgb "red" ps 1, "%(data_MBAR)s" u 1:15 t "MBAR optimal estimate" with points pt 6 lc rgb "black" ps 1, "%(NIST1)s" u 1:3 with lines t "NIST", "%(NIST2)s" u 1:3 with lines notitle, "%(NIST3)s" u 1:3 with lines notitle, "%(NIST4)s" u 1:3 with lines notitle, "%(NIST5)s" u 1:3 with lines notitle
        """ % vars()
    ...
    gnuplot_input = """
        ...
        set ylabel "aP (1/K)"
        set xrange [200:650]
        set yrange [0.0012:0.0032]
        set label "50 MPa" at 250,0.00311
        set label "60 MPa" at 250,0.00265
        set label "70 MPa" at 250,0.00235
        set label "80 MPa" at 250,0.00213
        set label "90 MPa" at 250,0.00195
        plot "%(data_STD)s" u 1:17 t "STD estimate" with points pt 7 lc rgb "red" ps 1, "%(data_MBAR)s" u 1:17 t "MBAR optimal estimate" with points pt 6 lc rgb "black" ps 1, "%(NIST1)s" u 1:14 with lines t "NIST", "%(NIST2)s" u 1:14 with lines notitle, "%(NIST3)s" u 1:14 with lines notitle, "%(NIST4)s" u 1:14 with lines notitle, "%(NIST5)s" u 1:14 with lines notitle
        """ % vars()
    outfile = open(gnuplot_in, 'w')
    outfile.write(gnuplot_input)
    outfile.close()
    ...
    gnuplot_input = """
        ...
        set ylabel "aP (1/MPa)"
        set xrange [250:700]
        set yrange [0.002:0.02]
        set label "50 MPa" at 640,0.0156
        set label "60 MPa" at 640,0.0123
        set label "70 MPa" at 640,0.01
        set label "80 MPa" at 640,0.0082
        set label "90 MPa" at 640,0.007
        plot "%(data_STD)s" u 1:19 t "STD estimate" with points pt 7 lc rgb "red" ps 1, "%(data_MBAR)s" u 1:19 t "MBAR optimal estimate" with points pt 6 lc rgb "black" ps 1, "%(NIST1)s" u 1:15 with lines t "NIST", "%(NIST2)s" u 1:15 with lines notitle, "%(NIST3)s" u 1:15 with lines notitle, "%(NIST4)s" u 1:15 with lines notitle, "%(NIST5)s" u 1:15 with lines notitle
        """ % vars()
    outfile = open(gnuplot_in, 'w')
    outfile.write(gnuplot_input)
    outfile.close()
    ...
    gnuplot_input = """
        ...
        set xrange [200:650]
        set yrange [48:62]
        set label "50 MPa" at 250,52
        set label "60 MPa" at 250,50.7
        set label "70 MPa" at 250,49.8
        set label "80 MPa" at 250,49.1
        set label "90 MPa" at 250,48.5
        plot "%(data_STD)s" u 1:22 t "STD estimate" with points pt 7 lc rgb "red" ps 1, "%(data_MBAR)s" u 1:22 t "MBAR optimal estimate" with points pt 6 lc rgb "black" ps 1, "%(NIST1)s" u 1:9 with lines t "NIST", "%(NIST2)s" u 1:9 with lines notitle, "%(NIST3)s" u 1:9 with lines notitle, "%(NIST4)s" u 1:9 with lines notitle, "%(NIST5)s" u 1:9 with lines notitle
        """ % vars()
    outfile = open(gnuplot_in, 'w')
    outfile.write(gnuplot_input)
    outfile.close()
    ...
    gnuplot_input = """
        ...
        set xrange [200:650]
        set yrange [29:50]
        set label "50 MPa" at 250,30 font "Arial,12"
    ...
    gnuplot_input = """
        ...
        set xrange [250:700]
        set yrange [-0.5:0.2]
        set label "90 MPa" at 640,-0.27
        set label "80 MPa" at 640,-0.225
        set label "70 MPa" at 640,-0.18
        set label "60 MPa" at 640,-0.12
        set label "50 MPa" at 640,-0.05
        plot "%(data_STD)s" u 1:26 t "STD estimate" with points pt 7 lc rgb "red" ps 1, "%(data_MBAR)s" u 1:26 t "MBAR optimal estimate" with points pt 6 lc rgb "black" ps 1, "%(NIST1)s" u 1:11 with lines t "NIST", "%(NIST2)s" u 1:11 with lines notitle, "%(NIST3)s" u 1:11 with lines notitle, "%(NIST4)s" u 1:11 with lines notitle, "%(NIST5)s" u 1:11 with lines notitle
        """ % vars()
    outfile = open(gnuplot_in, 'w')
    outfile.write(gnuplot_input)
    outfile.close()
    ...
    gnuplot_input = """
        ...
        set xrange [250:700]
        set yrange [750:1250]
        set label "90 MPa" at 640,975
        set label "80 MPa" at 640,930
        set label "70 MPa" at 640,885
        set label "60 MPa" at 640,840
        set label "50 MPa" at 640,800
        plot "%(data_STD)s" u 1:28 t "STD estimate" with points pt 7 lc rgb "red" ps 1, "%(data_MBAR)s" u 1:28 t "MBAR optimal estimate" with points pt 6 lc rgb "black" ps 1, "%(NIST1)s" u 1:10 with lines t "NIST", "%(NIST2)s" u 1:10 with lines notitle, "%(NIST3)s" u 1:10 with lines notitle, "%(NIST4)s" u 1:10 with lines notitle, "%(NIST5)s" u 1:10 with lines notitle
        """ % vars()
    outfile = open(gnuplot_in, 'w')
    outfile.write(gnuplot_input)
    outfile.close()
